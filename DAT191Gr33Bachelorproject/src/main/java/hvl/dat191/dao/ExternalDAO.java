...
public class ExternalDAO implements ExternalDAOInterface {
	...
	public void insertExternal(External ext) {
		...
		final String sql = "insert into external(externalId, name, companyNavn, phoneNr, email) values(:externalId,:name,:companyNavn,:phoneNr,:email)";
	
		KeyHolder holder = new GeneratedKeyHolder();
		SqlParameterSource param = new MapSqlParameterSource()
				.addValue("externalId", ext.getExternalId())
				.addValue("name", ext.getName())
				.addValue("companyNavn", ext.getCompanyName())
	...
	public void updateExternal(External ext) {
		...
		final String sql = "update external set name=:name, companyNavn=:companyNavn, phoneNr=:phoneNr, email=:email where externalId=:externalId";
	...
	public void executeUpdateExternal(External ext) {
		...
		map.put("companyNavn", ext.getCompanyName());
